...
namespace Tizen.Applications
{
    ...
    public class GadgetInfo
    {
        ...
        internal GadgetInfo(string packageId)
        {
            PackageId = packageId;
        ...
        /// </summary>
        /// <since_tizen> 13 </since_tizen>
        public string GadgetResourcePath { get; private set; }
        ...
        /// </summary>
        /// <since_tizen> 13 </since_tizen>
        public GadgetAssembly GadgetAssembly { get; set; }

        private static void SetGadgetResourcePath(GadgetInfo info)
        {
        ...
        private static void SetResourcePath(GadgetInfo info)
        {
        ...
        private static void SetResourceClassName(GadgetInfo info)
        {
        ...
        private static void SetResourceFile(GadgetInfo info)
        {
        ...
        private static void SetExecutableFile(GadgetInfo info)
        {
        ...
        private static void SetMetadata(GadgetInfo info, IntPtr handle)
        {
        ...
        private static void SetResourceVersion(GadgetInfo info, IntPtr handle)
        {
        ...
        private static void SetResourceType(GadgetInfo info, IntPtr handle)
        {
        ...
        internal static GadgetInfo CreateGadgetInfo(string packageId)
        {
            ...
            GadgetInfo info = new GadgetInfo(packageId);
