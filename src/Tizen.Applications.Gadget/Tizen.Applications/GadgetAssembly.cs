...
{
    internal class GadgetAssemblyLoadContext : AssemblyLoadContext
    {
        public GadgetAssemblyLoadContext() : base(isCollectible: true)
        {
        }
    ...
    /// <summary>
    /// Represents a class that provides access to the methods and properties of the GadgetAssembly.
    /// </summary>
    /// <since_tizen> 13 </since_tizen>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class GadgetAssembly
    {
        ...
        internal GadgetAssembly(string assemblyPath) { _assemblyPath = assemblyPath; }
        ...
        internal void Load()
        {
            lock (_assemblyLock)
            {
                ...
                GadgetAssemblyLoadContext context = new GadgetAssemblyLoadContext();
        ...
        /// <returns>The gadget instance.</returns>
        /// <since_tizen> 13 </since_tizen>
        ...
        internal void Unload()
        {
            lock (_assemblyLock)
            {
                ...
                {
                    (_assemblyRef.Target as GadgetAssemblyLoadContext).Unload();
                }
