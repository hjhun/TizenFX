...
namespace Tizen.Applications
{
    ...
    public class GadgetResourceManager
    {
        ...
        /// <since_tizen> 13 </since_tizen>
        public GadgetResourceManager(GadgetInfo info)
        {
            if (info == null)
            {
        ...
        /// <since_tizen> 13 </since_tizen>
        public GadgetResourceManager(string resourcePath, string resourceDll, string resourceClassName)
        {
